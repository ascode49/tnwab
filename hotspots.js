! function() {
    ...
    var f = p,
        ...
        x = p;
    var w = t.performance || {},
        N = w.now || w.mozNow || w.msNow || w.oNow || w.webkitNow || function() {
        ...
        ! function(e) {
            ...
            void 0 === n.Reflect ? n.Reflect = t : i = o(n.Reflect, i),
                function(t) {
                    ...
                    }, c = Object.getPrototypeOf(Function), d = "object" == typeof M && M.env && "true" === M.env.REFLECT_METADATA_USE_MAP_POLYFILL, h = d || "function" != typeof Map || "function" != typeof Map.prototype.entries ? et() : Map, u = d || "function" != typeof Set || "function" != typeof Set.prototype.entries ? nt() : Set, p = new(d || "function" != typeof WeakMap ? it() : WeakMap);
                    ...
                    function f(t, e, n, i) {
                        ...
                        if (!H(i) && !j(i) && !D(i)) throw new TypeError;
                        return D(i) && (i = void 0), _(t, e, n = W(n), i)
                    }

                    function m(t, e) {
                        function n(n, i) {
                            if (!H(n)) throw new TypeError;
                            if (!j(i) && !X(i)) throw new TypeError;
                            L(t, e, n, i)
                        }
                        return n
                    }
                    ...
                    function g(t, e, n, i) {
                        if (!H(n)) throw new TypeError;
                        return j(i) || (i = W(i)), L(t, e, n, i)
                    }

                    function v(t, e, n) {
                        if (!H(e)) throw new TypeError;
                        return j(n) || (n = W(n)), E(t, e, n)
                    }

                    function y(t, e, n) {
                        if (!H(e)) throw new TypeError;
                        return j(n) || (n = W(n)), A(t, e, n)
                    }

                    function b(t, e, n) {
                        if (!H(e)) throw new TypeError;
                        return j(n) || (n = W(n)), O(t, e, n)
                    }

                    function x(t, e, n) {
                        if (!H(e)) throw new TypeError;
                        return j(n) || (n = W(n)), I(t, e, n)
                    }

                    function w(t, e) {
                        if (!H(t)) throw new TypeError;
                        return j(e) || (e = W(e)), T(t, e)
                    }

                    function N(t, e) {
                        if (!H(t)) throw new TypeError;
                        return j(e) || (e = W(e)), B(t, e)
                    }
                    ...
                    function O(t, e, n) {
                        if (A(t, e, n)) return I(t, e, n);
                        var i = tt(e);
                        return D(i) ? void 0 : O(t, i, n)
                    }
                    ...
                    function V(t, e) {
                        if ("string" === e) {
                            var n = t.toString;
                            if (U(n))
                                if (!H(o = n.call(t))) return o;
                            if (U(i = t.valueOf))
                                if (!H(o = i.call(t))) return o
                        } else {
                            var i;
                            if (U(i = t.valueOf))
                                if (!H(o = i.call(t))) return o;
                    ...
                    t("decorate", f), t("metadata", m), t("defineMetadata", g), t("hasMetadata", v), t("hasOwnMetadata", y), t("getMetadata", b), t("getOwnMetadata", x), t("getMetadataKeys", w), t("getOwnMetadataKeys", N), t("deleteMetadata", C)
                }(i)
        }()
    }(k || (k = {}));
    var E = function() {
    ...
    function O(t, e, n, i) {
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(t, e, n, i);
            ...
            for (var a = t.length - 1; a >= 0; a--)(o = t[a]) && (r = (s < 3 ? o(r) : s > 3 ? o(e, n, r) : o(e, n)) || r);
    ...
    function P(t, e) {
        ...
        try {
            for (;
                (void 0 === e || e-- > 0) && !(i = s.next()).done;) r.push(i.value)
        } catch (t) {
            o = {
                error: t
            }
    ...
    var R = S((function(t, e) {
            var n, i = _ && _.__extends || (n = Object.setPrototypeOf || {
                    __proto__: []
                }
        ...
        z = S((function(t, e) {
            ...
            var o = function(t) {
                function e(n) {
                    ...
                    return i.name = "ServiceNotFoundError", "string" == typeof n ? i.message = 'Service "' + n + '" was not found, looks like it was not registered in the container. Register it by calling Container.set("' + n + '", ...) before using service.' : n instanceof H.Token && n.name ? i.message = 'Service "' + n.name + '" was not found, looks like it was not registered in the container. Register it by calling Container.set before using service.' : n instanceof H.Token && (i.message = "Service with a given token was not found, looks like it was not registered in the container. Register it by calling Container.set before using service."), Object.setPrototypeOf(i, e.prototype), i
                }
                return i(e, t), e
            }(Error);
        ...
        V = S((function(t, e) {
            ...
            var n = function() {
                ...
                return t.prototype.has = function(t) {
                    ...
                    if ("string" == typeof t || t instanceof H.Token) return this.set({
                        id: t,
                        value: e
                    });
                    if ("object" == typeof t && t.service) return this.set({
                        id: t.service,
                        value: e
                    });
                    if (t instanceof Function) return this.set({
                        type: t,
                        id: t,
                        value: e
                    });
                    ...
                    return this.services.find((function(e) {
                        return e.id ? t instanceof Object && e.id instanceof H.Token && t.service instanceof H.Token ? e.id === t.service : e.id === t : !!(e.type && t instanceof Function) && e.type === t
                    }))
                }, t.prototype.getServiceValue = function(t, e) {
                    var n;
                    if (e && void 0 !== e.value) return e.value;
                    if (!(e && e.type || e && e.factory || !("string" == typeof t || t instanceof H.Token))) throw new z.ServiceNotFoundError(t);
                    var i = void 0;
                    if (e && e.type ? i = e.type : e && e.id instanceof Function ? i = e.id : t instanceof Function && (i = t), !e) {
                        if (!i) throw new R.MissingProvidedServiceTypeError(t);
                        e = {
                            type: i
                        }, this.services.push(e)
                    }
                    var o, s = i && Reflect && Reflect.getMetadata ? Reflect.getMetadata("design:paramtypes", i) : void 0,
                        r = s ? this.initializeParams(i, s) : [];
                    if (e.factory) r = r.filter((function(t) {
                        return void 0 !== t
        ...
        F = S((function(t, e) {
            ...
            var n = function() {
                ...
                return t.of = function(t) {
                    ...
                    return e || (e = new V.ContainerInstance(t), this.instances.push(e)), e
                }, t.has = function(t) {
                    ...
                    } else this.globalInstance.reset(), this.instances.forEach((function(t) {
                        return t.reset()
                    }));
                    return this
                    ...
                    return this
                }, t.globalInstance = new V.ContainerInstance(void 0), t.instances = [], t.handlers = [], t
            }();
            e.Container = n
        })),
        q = S((function(t, e) {
            Object.defineProperty(e, "__esModule", {
                ...
                return function(e) {
                    ...
                    "string" == typeof t || t instanceof H.Token ? (n.id = t, n.multiple = t.multiple, n.global = t.global || !1, n.transient = t.transient) : t && (n.id = t.id, n.factory = t.factory, n.multiple = t.multiple, n.global = t.global || !1, n.transient = t.transient), F.Container.set(n)
                }
            }
        })),
        W = S((function(t, e) {
            ...
            Object.defineProperty(e, "__esModule", {
                ...
                return function(e, n, i) {
                    t || (t = function() {
                        ...
                        value: function(i) {
                            var o;
                            if ((o = "string" == typeof t || t instanceof H.Token ? t : t()) === Object) throw new W.CannotInjectError(e, n);
                            return i.get(o)
                        }
                    })
                }
        ...
        G = S((function(t, e) {
            ...
            var i = F;
            e.Container = i.Container, e.ContainerInstance = V.ContainerInstance, e.Token = H.Token, e.default = F.Container
        })),
        X = function(t) {
            for (var e, n = []; null != t.parentNode;) e = t.getAttribute("data-id"), n.unshift({
        ...
        Z = function() {
            function t() {
                this.nodes = {}, this.links = document.querySelectorAll("a"), this.linksMap = [], this.serverOverrides = {}, this.modelNodes = {}, this.childToInstanceMap = {}, this.selectedNode = null, this.isOverridesActivated = !1, this.whitelist = null, this.inlineEventsMap = {}, this.generatedViews = {}, this.listOfInlineEvents = ["onclick", "onmouseover", "onmouseout", "onkeydown", "onclick"], this.fixedBox = null, this.box = null, this.storeLinks(), this.onMouseOver = this.onMouseOver.bind(this), this.onMouseOut = this.onMouseOut.bind(this), this.onClick = this.onClick.bind(this), this.resetAllBoxes = this.resetAllBoxes.bind(this), this.updateBoxesPosition = this.updateBoxesPosition.bind(this)
            }
            return t.prototype.activate = function() {
                this.isOverridesActivated || (console.log("ov-activate"), document.body.setAttribute("mode", "code"), this.createAllBoxes(), this.addStyles(), this.disableLinks(), this.addDocumentListeners(), this.addWindowListeners(), this.isOverridesActivated = !0, this.resetAllBoxes(), parent.postMessage({
                ...
                if (!document.querySelector("#overrides-styles")) {
                    ...
                    t.setAttribute("id", "overrides-styles"), t.innerHTML = Q, document.head.appendChild(t)
                }
                ...
                return a.classList.add("tag-component-name"), s.appendChild(r), s.appendChild(a), o.appendChild(s), i.appendChild(o), document.body.appendChild(i), {
                    boxEl: i,
                    boxWrapper: o,
                    boxElTag: s,
                    boxElTagName: r,
                ...
                if (void 0 === n && (n = {}), e && t) {
                    ...
                    if (Object.assign(e.boxEl.style, {
                            width: t.offsetWidth + "px",
                            height: t.offsetHeight + "px",
                            transform: "translate3d(" + Math.max(0, i.x + o) + "px," + Math.max(0, i.y + s) + "px,0)",
                            display: "block"
                        }), e.boxEl.style.setProperty("--width", t.offsetWidth + "px"), e.boxEl.style.setProperty("--width", t.offsetWidth + "px"), e.boxElTag.style.setProperty("--tag-box-width", "auto"), e.boxElTag.style.setProperty("--tag-box-left", "0px"), e.boxElTag.style.setProperty("--tag-box-top", "-20px"), !n.flat) {
                ...
                (t && Array.isArray(t) && (this.whitelist = 0 === t.length ? null : t), t && 0 !== t.length) || j(document.querySelectorAll(".ignore")).forEach((function(t) {
                ...
                for (var e = this, n = {}, i = 0; i < t.length; i++) {
                    ...
                    if (s) {
                        var r = Array.from(s.querySelectorAll("[data-id]")).map((function(t) {
                ...
                if (e && t) {
                    var n = this.findParentWithId(t),
                        i = this.getNodeId(n),
                        o = ["class", "style", "data-id", "anima-layer", "anima-container", "component", "anima-component-wrapper", "anima-not-ready", "anima-word-break", "anima-hidden", "anima-smart-layers-pointers", "id", "anima-show-on-scroll", "data-initial-state"],
                ...
                return this.selectedNode ? X(this.selectedNode) : t ? X(t) : []
                ...
                return L(this, void 0, void 0, (function() {
                    ...
                    return T(this, (function(o) {
                        return e = t.nodeId, n = A(t, ["nodeId"]), e ? (this.sendMessage("on-preview-start", E({
                            nodeId: e
                        }, n)), this.takeNodeScreenShot(e).then((function(t) {
                            i.sendMessage("on-preview-end", E({
                                error: null,
                                nodeId: e,
                                base64: t
                            }, n))
                ...
                return L(this, void 0, void 0, (function() {
                    ...
                    return T(this, (function(c) {
                        switch (c.label) {
                            case 0:
                                return (e = this.getNodeById(t)) ? (n = Array.from(e.querySelectorAll("img")), i = [], n.forEach((function(t) {
                                    var e = t.src;
                                    ...
                                    t.src = e
                                })), o = getComputedStyle(e).backgroundColor, s = document.body.style.backgroundColor, [4, html2canvas(e, {
                ...
                void 0 === e && (e = {}), parent.postMessage({
                    action: t,
                    data: e
                }, "*")
            }, t.prototype.registerNode = function(t) {
                var e = this.getNodeId(t);
                e && (this.nodes[e] || (this.nodes[e] = {
                    isModifed: !1,
                ...
                g.setAttribute("id", f);
                for (var v, y, b = [], x = d.borderColor || "#ffcb6b", w = d.borderWidth || "2px", N = d.background || "rgba(255, 203, 107, 0.2)", C = function(t) {
                        var n = p[t],
                            i = k.getNodeById(n);
                        ...
                        var s = document.createElement("div");
                        s.setAttribute("class-highlighter", "true"), Object.assign(s.style, {
                            position: "absolute",
                            opacity: 0,
                            zIndex: -1,
                            top: 0,
                            left: 0,
                            background: N,
                            boxShadow: "inset 0 0 0 " + w + " " + x
                        }), b.push(s), g.appendChild(s);
                        var a = 0,
                            c = 0;
                        if (k.generatedViews[n]) {
                            ...
                            var u = Math.min.apply(Math, j(h.map((function(t) {
                                    return t.x
                                })))),
                                f = Math.min.apply(Math, j(h.map((function(t) {
                                    return t.y
                                })))),
                                m = Math.max.apply(Math, j(h.map((function(t) {
                                    return t.xw
                                })))),
                                C = Math.max.apply(Math, j(h.map((function(t) {
                                    return t.yh
                                })))),
                            ...
                            a = m - u, c = C - f, Object.assign(s.style, {
                                width: a + "px",
                                height: c + "px",
                                transform: "translate3d(" + Math.max(0, u + M) + "px," + Math.max(0, f + _) + "px,0)",
                                display: "block"
                            }), s.style.setProperty("--width", m - u + "px")
                        } else i && (a = i.offsetWidth, c = i.offsetHeight, k.setBoxPosition(i, {
                            boxEl: s
                        }, {
                            flat: !0
                        }), r && k.scrollToElement(i, {
                            center: o,
                            viewport: l
                        }));
                        ...
                        }), a >= v && k.scrollbarVisible(document.documentElement) && Object.assign(s.style, {
                            width: v - 10 + "px"
                        })
                    }, k = this, M = 0; M < p.length; M++) C(M);
                if (document.body.appendChild(g), u) var _ = 2,
                    S = 2,
                    E = setInterval((function() {
                        return _ <= 0 && S > 0 ? (S--, void(_ = 2)) : _ <= 0 && 0 == S ? (clearInterval(E), void b.forEach((function(t) {
                ...
                return void 0 === e && (e = {}), L(this, void 0, void 0, (function() {
                    var n, i, o, s, r, a, l, c = this;
                    return T(this, (function(d) {
                        return (n = this.getNodeId(t)) ? (i = this.serverOverrides[n] || {}, o = e.extra || {}, s = this.getExtFromFileName(i.capture_url), r = i.capture_type || "", a = this.isImage(n, {
                            native: !1
                        }) && !i.capture_url, l = this.isImage(n, {
                            native: !1
                        }) && i.capture_url && s != r, (a || l) && (this.sendMessage("on-capture-start", {
                            nodeId: n
                        }), this.takeNodeScreenShot(n).then((function(t) {
                        ...
                        }))), this.registerNode(t), this.fixedBox && (this.fixedBox.boxElTagName.innerHTML = this.isImage(n) ? "img" : t.tagName.toLowerCase(), this.setComponentName(this.fixedBox.boxElComponentName, n), this.setBoxPosition(t, this.fixedBox, o)), this.selectedNode = t, this.sendNodeData(t, e), [2]) : [2]
                    }))
                }))
                ...
                t && (this.nodes[t].isModifed = !0, this.sendNodeData(this.selectedNode, {
                    source: "override"
                }), this.setBoxPosition(this.selectedNode, this.fixedBox), this.resetBox(this.box))
                ...
                var e, n, i, o = this.getNodeId(this.selectedNode);
                if (o && this.selectedNode && this.selectedNode.tagName.toLowerCase() != t.toLowerCase()) {
                    ...
                    s.innerHTML = this.selectedNode.innerHTML, null === (i = this.selectedNode.parentNode) || void 0 === i || i.replaceChild(s, this.selectedNode), this.selectedNode = s, this.fixedBox && (this.fixedBox.boxElTagName.innerHTML = this.selectedNode.tagName.toLowerCase()), this.nodes[o].tagName = t.toLowerCase()
                }
            }, t.prototype.updateOriginalAttribute = function(t) {
                var e = this.getNodeId(this.selectedNode);
                e && this.selectedNode && (this.selectedNode.setAttribute(t.name, t.value), this.nodes[e].originalAttributes = this.nodes[e].originalAttributes.map((function(e) {
                    return e.name == t.name ? E(E({}, e), {
                        value: t.value
                    }) : e
                ...
                if (e && this.selectedNode)
                    if (this.selectedNode.setAttribute(t.name, t.value), this.nodes[e].customAttributes.find((function(e) {
                            return e.name == t.name
                        }))) {
                        var n = this.nodes[e].customAttributes.map((function(t) {
                            return t.name
                        })).indexOf(t.name);
                ...
                var e = t.target,
                    n = this.getNodeId(e);
                n && (this.whitelist && this.whitelist.length > 0 && !this.whitelist.includes(n) ? e.classList.add("ignore") : (this.box && (this.box.boxElTagName.innerHTML = this.isImage(n) ? "img" : e.tagName.toLowerCase(), this.setComponentName(this.box.boxElComponentName, n)), this.stripEventsFromNode(e), this.setBoxPosition(e, this.box)))
            }, t.prototype.onMutatedMouseOver = function(t) {
                var e = t.target,
                    n = this.getNodeId(e);
                if (n) {
                    var i = this.modelNodes[n];
                    if (i && i.is_root_screen && this.whitelist && this.whitelist.length > 0 && (this.whitelist.includes(n) || this.whitelist.push(n)), this.whitelist && this.whitelist.length > 0 && !this.whitelist.includes(n)) e.classList.add("ignore");
                    else {
                        var o, s = {};
                        if (this.childToInstanceMap[n]) e = this.getNodeById(this.childToInstanceMap[n]);
                        else {
                            var r = !1;
                            for (r = !this.isRootNode(n, e) && this.hasSameDimensionsAsParent(e); r;) this.isLeaf(e) && !o && (o = parseInt(getComputedStyle(e).getPropertyValue("border-radius") || "", 10)), e = this.findParentWithId(e), r = this.hasSameDimensionsAsParent(e)
                        }
                ...
                if (s) {
                    ...
                    if (this.childToInstanceMap[s]) o = this.getNodeById(this.childToInstanceMap[s]);
                        ...
                        var a = !1;
                        for (this.isRootNode(s) || (a = this.hasSameDimensionsAsParent(o)); a;) this.isLeaf(o) && !r.radius && (r.radius = parseInt(getComputedStyle(o).getPropertyValue("border-radius") || "", 10)), o = this.findParentWithId(o), a = this.hasSameDimensionsAsParent(o)
                    }
                    var l = getComputedStyle(o),
                        c = parseInt(l.getPropertyValue("border-radius") || "", 10);
                    c && (r.radius = c), j(o.classList).includes("ignore") || this.selectNode(o, {
                        source: i,
                        extra: r
                    })
                }
                ...
                Object.keys(t).forEach((function(i) {
                    if ("globalCSS" != i) {
                        ...
                        if (s) {
                            ...
                            })), e.nodes[i].customAttributes = a, e.nodes[i].originalAttributes = l, o.originalAttributes && Object.keys(o.originalAttributes).forEach((function(t) {
                            ...
                            })), e.setHTMLContent(u), e.setInlineCSS(h), e.ChangeTagName(d)
                        }
                    }
                })), console.log(n + " element overrides processed")
            }, t = O([G.Service(), I("design:paramtypes", [])], t)
        }(),
        K = function() {
            function t() {
                this.clickableAreas = [], this.count = 1, this.counter = null, this.hotspots = null, this.isHotspotsActivated = !1, this.specialTags = ["INPUT", "VIDEO"], this.addStyles(), this.disableStyles(), this.onMouseDown = this.onMouseDown.bind(this), this.updatePosition = this.updatePosition.bind(this)
            }
            return t.prototype.createHotspots = function() {
                var t, e, n = document.querySelector("#hotspots_wrapper");
                ...
                this.isHotspotsActivated || (console.log("hp-activate"), this.activateStyles(), document.addEventListener("mousedown", this.onMouseDown), window.addEventListener("resize", this.updatePosition, !1), this.isHotspotsActivated = !0)
            }, t.prototype.deactivate = function() {
                this.isHotspotsActivated && (console.log("hp-deactivate"), this.reset(), this.disableStyles(), document.removeEventListener("mousedown", this.onMouseDown), window.removeEventListener("resize", this.updatePosition, !1), this.isHotspotsActivated = !1)
                ...
                var t = document.createElement("style");
                t.setAttribute("id", "hotspots-styles"), t.innerHTML = "\n    .hotspot {\n      position: absolute;\n      border: 1px solid #2a9fd8;\n      background: rgba(0, 173, 255, 0.54);\n      opacity: 0;\n      z-index: -1;\n      pointer-events:none;\n    }\n  ", document.head.appendChild(t)
                ...
                var e = this;
                t.target && Array.from(this.clickableAreas).every((function(e) {
                    return !e.contains(t.target)
                })) && !this.specialTags.includes(t.target.nodeName) && (this.count = 1, this.reset(), this.counter && clearInterval(this.counter), this.counter = setInterval((function() {
                ...
                if (null !== t) {
                    if (r++, 1 === t.nodeType) {
                        ...
                        if (t.data === st) {
                            ...
                            null !== t.previousSibling && r !== s || (r++, e.insertBefore(ut(), t)), s = r, this.parts.push({
                                type: "node",
                                index: r
                            }), null === t.nextSibling ? t.data = "" : (n.push(t), r--), a++
                        } else {
                            let e = -1;
                            for (; - 1 !== (e = t.data.indexOf(st, e + 1));) this.parts.push({
                                type: "node",
                                index: -1
                            }), a++
                        }
    ...
    const mt = window.trustedTypes && trustedTypes.createPolicy("lit-html", {
            createHTML: t => t
        }),
        gt = ` ${st} `;
    class vt {
    ...
    class Nt {
        ...
        commit() {
            ...
            const t = this.__pendingValue;
            t !== it && (yt(t) ? t !== this.value && this.__commitText(t) : t instanceof vt ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : bt(t) ? this.__commitIterable(t) : t === ot ? (this.value = ot, this.clear()) : this.__commitText(t))
        }
        __insert(t) {
        ...
        __commitIterable(t) {
            ...
            const e = this.value;
            let n, i = 0;
            for (const o of t) n = e[i], void 0 === n && (n = new Nt(this.options), e.push(n), 0 === i ? n.appendIntoPart(this) : n.insertAfterPart(e[i - 1])), n.setValue(o), n.commit(), i++;
    ...
    class St {
        ...
        commit() {
            ...
            const t = this.__pendingValue,
                ...
                i = null != t && (null == e || n);
            n && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options), i && (this.__options = Et(t), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)), this.value = t, this.__pendingValue = it
        }
        handleEvent(t) {
    ...
    const At = new class {
        handleAttributeExpressions(t, e, n, i) {
            ...
            if ("?" === o) return [new Ct(t, e.slice(1), n)];
            return new xt(t, e, n).parts
        }
    ...
    const It = new Map,
        ...
        Tt = (t, e, n) => {
            let i = Lt.get(e);
            void 0 === i && (nt(e, e.firstChild), Lt.set(e, i = new Nt(Object.assign({
                templateFactory: Ot
    ...
    const Bt = (t, ...e) => new vt(t, e, "html", At),
        Pt = new WeakMap,
        jt = J(t => e => {
            if (!(e instanceof wt) || e instanceof Mt || "style" !== e.committer.name || e.committer.parts.length > 1) throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");
            const {
                committer: n
            } = e, {
                style: i
            ...
            let o = Pt.get(e);
            void 0 === o && (i.cssText = n.strings.join(" "), Pt.set(e, o = new Set)), o.forEach(e => {
    ...
    const Rt = new WeakMap,
        Ht = J(t => e => {
            if (!(e instanceof wt) || e instanceof Mt || "class" !== e.committer.name || e.committer.parts.length > 1) throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");
            const {
                committer: n
            } = e, {
                element: i
            ...
            let o = Rt.get(e);
            void 0 === o && (i.setAttribute("class", n.strings.join(" ")), Rt.set(e, o = new Set));
            const s = i.classList || new Dt(i);
            o.forEach(e => {
    ...
    var zt, Vt, Ft, qt = function() {
            function t(e, n, i) {
                var o = this;
                this.options = {
                    position: t.BOTTOM
                }, this.element = e, this.trigger = n, this._isOpen = !1, Object.assign(this.options, i), this.events(), requestAnimationFrame((function() {
                    o.position()
                }))
            }
            return t.prototype.events = function() {
                ...
                var n = (void 0 === e ? {} : e).force,
                    i = void 0 !== n && n;
                this.targetIsInsideElement(t) && !i || !this._isOpen || (this.element.style.display = "none", this.options.width && (this.element.style.width = "0"), this.options.height && (this.element.style.height = "0"), this._isOpen = !1, this.trigger.classList.remove("pop-active"), this.killOutSideClick(), this.options.callback && this.options.callback({
                    closed: !0
                }))
                ...
                if (this.element.classList.remove(t.TOP, t.BOTTOM, t.LEFT, t.RIGHT), this.element.classList.add(r), -1 !== r.indexOf(t.BOTTOM)) this.element.style.left = (o.left + (o.width / 2 - s.width / 2)).toFixed(2) + "px", this.element.style.top = o.bottom + "px";
                ...
                } else -1 !== r.indexOf(t.LEFT) ? (this.element.style.top = (o.top + o.height / 2 - s.height / 2).toFixed(2) + "px", this.element.style.left = (o.left - s.width).toFixed(2) + "px") : (this.element.style.top = (o.top + o.height / 2 - s.height / 2).toFixed(2) + "px", this.element.style.left = o.right + "px")
                ...
                return this._isOpen
            }, t.TOP = "top", t.BOTTOM = "bottom", t.LEFT = "left", t.RIGHT = "right", t
        }(),
        Wt = function() {
            function t() {
                if (this.showRestartButton = !1, this.pageSlugs = [], this.pages = [], this.queryMap = {}, !this.isInOmniview()) {
                    var t = new Date;
                    document.cookie = "ana_visitorId=" + Math.random().toString(36).substr(2, 9) + ";expires=" + t.toUTCString() + ";path=/;domain=animaapp.io"
                }
            }
            return t.prototype.getWindowUrl = function() {
                ...
                if (void 0 === e && (e = {}), this.tracking) try {
                ...
                this.addActionLinksStyles(), this.createActionLinks(), this.createPrivatePreviewBanner()
                ...
                var a, l, c, d = document.createElement("div");
                d.setAttribute("id", "anima-watermark"), document.body.appendChild(d);
                var h = function(t) {
                        t && (r.contains(t.target) || d.contains(t.target)) || (a && clearTimeout(a), r.classList.remove("idle"), d.classList.remove("idle"), a = setTimeout((function() {
                            r.classList.add("idle"), window._forceShowAnimaWatermark || d.classList.add("idle"), l && l.close(null, {
                                force: !0
                            }), c && c.close(null, {
                                force: !0
                            })
                ...
                })), r), Tt(p(), d), requestAnimationFrame((function() {
                ...
                if (e && e.includes(".animaapp.io") && t) {
                    ...
                    Tt((i = jt({
                        ...
                        alignItems: "center"
                    }), Bt(Ft || (Ft = D(["\n        <div style=", '>\n          <div></div>\n          <div style="display:flex;align-items:center;">\n            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n              <path d="M12 22C6.48587 22 2 17.5137 2 12C2 6.48587 6.48587 2 12 2C17.5137 2 22 6.48587 22 12C22 17.5137 17.5137 22 12 22ZM12 2.99998C7.03757 2.99998 2.99998 7.03757 2.99998 12C2.99998 16.9629 7.03757 21 12 21C16.9629 21 21 16.963 21 12C21 7.03757 16.9629 2.99998 12 2.99998Z" fill="#3366FF"/>\n              <path d="M12.053 7C11.4727 7 11.0006 7.47242 11.0006 8.05311C11.0006 8.63326 11.4727 9.10526 12.053 9.10526C12.6333 9.10526 13.1055 8.63326 13.1055 8.05311C13.1055 7.47242 12.6333 7 12.053 7Z" fill="#3366FF"/>\n              <path d="M12.0531 10.6842C11.6171 10.6842 11.2637 11.0377 11.2637 11.4737V16.2105C11.2637 16.6465 11.6171 17 12.0531 17C12.4891 17 12.8426 16.6465 12.8426 16.2105V11.4737C12.8426 11.0377 12.4891 10.6842 12.0531 10.6842Z" fill="#3366FF"/>\n            </svg>\n            <div style="margin-left:10px;">Private preview - only you can see it.</div>\n          </div>\n          <div style="cursor:pointer" @click=', '>\n            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n              <rect width="0.995992" height="18.9242" rx="0.497996" transform="matrix(0.70425 0.709952 -0.702683 0.711503 18.2986 5)" fill="#3B3B3B"/>\n              <rect width="0.995992" height="18.9242" rx="0.497996" transform="matrix(0.70425 -0.709952 0.702683 0.711503 5 5.70703)" fill="#3B3B3B"/>\n            </svg>\n          </div>\n        </div>\n      '], ["\n        <div style=", '>\n          <div></div>\n          <div style="display:flex;align-items:center;">\n            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n              <path d="M12 22C6.48587 22 2 17.5137 2 12C2 6.48587 6.48587 2 12 2C17.5137 2 22 6.48587 22 12C22 17.5137 17.5137 22 12 22ZM12 2.99998C7.03757 2.99998 2.99998 7.03757 2.99998 12C2.99998 16.9629 7.03757 21 12 21C16.9629 21 21 16.963 21 12C21 7.03757 16.9629 2.99998 12 2.99998Z" fill="#3366FF"/>\n              <path d="M12.053 7C11.4727 7 11.0006 7.47242 11.0006 8.05311C11.0006 8.63326 11.4727 9.10526 12.053 9.10526C12.6333 9.10526 13.1055 8.63326 13.1055 8.05311C13.1055 7.47242 12.6333 7 12.053 7Z" fill="#3366FF"/>\n              <path d="M12.0531 10.6842C11.6171 10.6842 11.2637 11.0377 11.2637 11.4737V16.2105C11.2637 16.6465 11.6171 17 12.0531 17C12.4891 17 12.8426 16.6465 12.8426 16.2105V11.4737C12.8426 11.0377 12.4891 10.6842 12.0531 10.6842Z" fill="#3366FF"/>\n            </svg>\n            <div style="margin-left:10px;">Private preview - only you can see it.</div>\n          </div>\n          <div style="cursor:pointer" @click=', '>\n            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n              <rect width="0.995992" height="18.9242" rx="0.497996" transform="matrix(0.70425 0.709952 -0.702683 0.711503 18.2986 5)" fill="#3B3B3B"/>\n              <rect width="0.995992" height="18.9242" rx="0.497996" transform="matrix(0.70425 -0.709952 0.702683 0.711503 5 5.70703)" fill="#3B3B3B"/>\n            </svg>\n          </div>\n        </div>\n      '])), i, (function() {
                        return n.remove()
                    }))), n)
                }
        ...
        Yt = function() {
            function t() {
                this.isDev = !1, this.nodes = {}, this.webComponentsIds = [], this.links = document.querySelectorAll("a"), this.linksMap = [], this.serverOverrides = {}, this.modelNodes = {}, this.selectedNode = null, this.isOverridesActivated = !1, this.whitelist = null, this.inlineEventsMap = {}, this.generatedViews = {}, this.listOfInlineEvents = ["onclick", "onmouseover", "onmouseout", "onkeydown", "onclick"], this.selectableLayers = {}, this.fixedBox = null, this.box = null, this.storeLinks(), this.onMouseOver = this.onMouseOver.bind(this), this.onMouseOut = this.onMouseOut.bind(this), this.onClick = this.onClick.bind(this), this.resetAllBoxes = this.resetAllBoxes.bind(this), this.updateBoxesPosition = this.updateBoxesPosition.bind(this)
            }
            return t.prototype.activate = function() {
                this.isOverridesActivated || (console.log("ov-activate"), document.body.setAttribute("mode", "code"), this.createAllBoxes(), this.addStyles(), this.disableLinks(), this.addDocumentListeners(), this.addWindowListeners(), this.isOverridesActivated = !0, this.resetAllBoxes(), parent.postMessage({
                    action: "overrides-activated"
                ...
                this.isOverridesActivated && (this.restoreAllNodeEvents(), this.destroyAllBoxes(), this.enableLinks(), this.removeDocumentListeners(), this.removeWindowListeners(), document.body.removeAttribute("mode"), this.isOverridesActivated = !1)
            }, t.prototype.addStyles = function() {
                if (!document.querySelector("#overrides-styles")) {
                    var t = document.createElement("style");
                    t.setAttribute("id", "overrides-styles"), t.innerHTML = Q, document.head.appendChild(t)
                ...
                if (void 0 === n && (n = {}), e && t) {
                    ...
                    if (Object.assign(e.boxEl.style, {
                            ...
                            display: "block"
                        }), null === (i = e.boxEl) || void 0 === i || i.style.setProperty("--width", t.offsetWidth + "px"), null === (o = e.boxElTag) || void 0 === o || o.style.setProperty("--tag-box-width", "auto"), null === (s = e.boxElTag) || void 0 === s || s.style.setProperty("--tag-box-left", "0px"), null === (r = e.boxElTag) || void 0 === r || r.style.setProperty("--tag-box-top", "-20px"), !n.flat) {
                ...
                return void 0 === e && (e = {}), L(this, void 0, void 0, (function() {
                    ...
                    return T(this, (function(i) {
                        return (n = this.getNodeId(t)) ? (this.registerNode(t), this.fixedBox && (this.fixedBox.boxElTagName.innerHTML = this.isImage(n) ? "img" : t.tagName.toLowerCase(), this.setComponentName(this.fixedBox.boxElComponentName, n), this.setBoxPosition(t, this.fixedBox)), this.selectedNode = t, this.sendNodeData(t, e), [2]) : [2]
                    }))
                }))
            }, t.prototype.findParentWithId = function(t) {
                var e = t.parentNode || null;
                ...
                var e = t.target,
                    n = this.getNodeId(e);
                n && (this.isNodeSelectable(n) ? (this.box && (this.box.boxElTagName.innerHTML = this.isImage(n) ? "img" : e.tagName.toLowerCase(), this.setComponentName(this.box.boxElComponentName, n)), this.stripEventsFromNode(e), this.setBoxPosition(e, this.box)) : e.classList.add("ignore"))
            }, t.prototype.onMutatedMouseOver = function(t) {
                var e = t.target,
                    n = this.getNodeId(e);
                if (n)
                    if (this.isNodeSelectable(n)) {
                        ...
                        this.stripEventsFromNode(e), this.setBoxPosition(e, this.box, {
                            radius: o
                        })
                ...
                var n;
                return !(!e && !t) && (!t && e && (t = this.getNodeId(e)), !!t && (e || (e = this.getNodeById(t)), (null === (n = this.modelNodes[t]) || void 0 === n ? void 0 : n.is_root_screen) || Array.from((null == e ? void 0 : e.classList) || []).includes("screen")))
            }, t.prototype.onClick = function(t, e) {
                var n = (void 0 === e ? {} : e).source,
                    i = void 0 === n ? "iframe" : n;
                t.stopImmediatePropagation(), t.stopPropagation(), t.preventDefault();
                var o = t.target,
                    s = this.getNodeId(o);
                s && (this.isNodeSelectable(s) ? this.selectNode(o, {
                    source: i
        ...
        Ut = function() {
            function t() {
                this.nodes = {}, this.links = document.querySelectorAll("a"), this.linksMap = [], this.selectedNode = null, this.isActivated = !1, this.onMouseOver = this.onMouseOver.bind(this), this.onMouseOut = this.onMouseOut.bind(this), this.onClick = this.onClick.bind(this), this.resetAllBoxes = this.resetAllBoxes.bind(this), this.updateBoxesPosition = this.updateBoxesPosition.bind(this), this.fixedBox = null, this.box = null, this.storeLinks()
            }
            return t.prototype.createBox = function(t) {
                var e = (void 0 === t ? {} : t).className,
                    n = void 0 === e ? "" : e,
                    i = document.createElement("div");
                ...
                var s = document.createElement("div");
                return s.classList.add("comment-box-tag"), o.appendChild(s), i.appendChild(o), document.body.appendChild(i), {
                    boxEl: i,
                    boxWrapper: o,
                    boxElTag: s,
                ...
                if (t && e) {
                    var n = t.getBoundingClientRect(),
                        i = window.pageXOffset || window.document.documentElement.scrollLeft,
                        o = window.pageYOffset || window.document.documentElement.scrollTop;
                    e.boxEl && Object.assign(e.boxEl.style, {
                        width: t.offsetWidth + "px",
                        height: t.offsetHeight + "px",
                ...
                if (!document.querySelector("#comments-styles")) {
                    var t = document.createElement("style");
                    t.setAttribute("id", "comments-styles"), t.innerHTML = '\n.comment-box {\n  position: absolute;\n  border: 1px solid #ff6250;\n  background: rgba(255, 98, 80,0.1);\n  pointer-events: none;\n  box-sizing: border-box;\n  top:-20px;\n  left:-20px;\n}\n.comment-box-wrapper {\n  width:100%;\n  height:100%;\n  position:relative\n}\n.comment-box-tag {\n  position: absolute;\n  left: 0;\n  top: -20px;\n  height: 20px;\n  width: auto;\n  padding: 0px 8px;\n  background:#ff6250;\n  color:#fff;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family:-apple-system, BlinkMacSystemFont, "Open Sans",sans-serif;\n  font-weight:600;\n  font-size:14px;\n}\n.comment-number{\n  position: absolute;\n  display: inline-block;\n  width: 30px;\n  height: 30px;\n  border-radius: 50%;\n  background: cornflowerblue;\n  color: white;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 12px;\n  font-weight: 600;\n  font-family:sans-serif;\n}\n', document.head.appendChild(t)
                }
            }, t.prototype.removeStyles = function() {
                ...
                this.isActivated || (console.log("co-activate"), document.body.setAttribute("mode", "comments"), this.createAllBoxes(), this.addStyles(), this.disableLinks(), this.addDocumentListeners(), this.addWindowListeners(), this.isActivated = !0, parent.postMessage({
                    action: "comments-activated"
                }, "*"))
            }, t.prototype.deactivate = function() {
                this.isActivated && (console.log("co-deactivate"), document.body.removeAttribute("mode"), this.removeStyles(), this.enableLinks(), this.destroyAllBoxes(), this.removeCircles(), this.removeDocumentListeners(), this.removeWindowListeners(), this.isActivated = !1)
            }, t.prototype.onMouseOver = function(t) {
                ...
                n && this.fixedBox && (this.fixedBox.boxElTag.innerHTML = t.tagName.toLowerCase(), this.setBoxPosition(t, this.fixedBox), this.nodes[n] || (this.nodes[n] = {
                    id: n,
                    number: 0,
                    tagName: t.tagName.toLowerCase()
                }), this.selectedNode = t, this.sendNodeData(t, e))
            }, t.prototype.disableLinks = function() {
                for (var t = 0; t < this.links.length; t++) {
                    this.links[t].removeAttribute("href")
                }
                ...
                var t, e, n = document.querySelectorAll(".comment-number");
                try {
        ...
        Gt = S((function(t, e) {
            void 0 !== _ || _.window || _.global, t.exports = function() {
                function t(t, e) {
                    var n = [];
                    return e.forEach((function(e) {
                ...
                function s(t, e) {
                    ...
                    if (t) {
                        ...
                        if (n(e))
                            for (var o in e) o in i || (o = "-webkit-" + o), t.style[o] = e[o] + ("string" == typeof e[o] || "opacity" === o ? "" : "px")
                    }
                }
                ...
                function r(t) {
                    ...
                    return e = void 0 !== e.pageYOffset ? e.pageYOffset : n.scrollTop, {
                        x1: t.left + i,
                        x2: t.left + t.width + i,
                        y1: t.top + e,
                        y2: t.top + t.height + e,
                ...
                function a(t, e, n) {
                    var i;
                    return function() {
                        if (n = n || this, !i) return t.apply(n, arguments), i = !0, setTimeout((function() {
                            i = !1
                        }), e)
                    }
                }
                var l = "classList" in document.documentElement,
                    ...
                    f = function(t) {
                        this.version = "0.17.8", this.v = this.version.split(".").map((function(t) {
                            return parseInt(t, 10)
                        })), this.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch, this.init(t)
                    };
                return f.prototype = {
                    init: function(t) {
                        var e = this;
                        ...
                        var r = this.config;
                        this.autoscroll = n(r.autoScroll), this.lasso = !1, r.lasso && n(r.lasso) && (this.lasso = document.createElement("div"), this.lasso.className = r.classes.lasso, s(this.lasso, o({
                            position: "absolute",
                            boxSizing: "border-box",
                            opacity: 0
                        }, r.lasso))), this.touch && (r.toggle = r.toggleTouch), r.touch || (this.touch = !1), this.events = {}, e = this, "_start _touchstart _drag _end _keyup _keydown _blur _focus".split(" ").forEach((function(t) {
                            e.events[t] = e[t].bind(e)
                        })), this.events._refresh = a(this.refresh, r.throttle, this), this.autoscroll && (this.events._scroll = this._onScroll.bind(this)), this.setContainer(), this.scroll = {
                        ...
                        }, i(r.filter) ? this.nodes = [].slice.call(r.filter) : "string" == typeof r.filter && (this.nodes = [].slice.call(this.container.querySelectorAll(r.filter))), this.nodes.forEach((function(t) {
                            c.add(t, r.classes.selectable)
                        })), this.update(), this.enable(), setTimeout((function() {
                    ...
                    setContainer: function(t) {
                        ...
                        "string" == typeof(t = t || e.appendTo) ? this.container = document.querySelector(t): t instanceof Element && t.nodeName && (this.container = t), c.add(this.container, e.classes.container), this.container._selectable = this, n && (c.remove(n, e.classes.container), delete n._selectable), this.bodyContainer = this.container === document.body, this._loadItems(), this.autoscroll && "static" === s(this.container).position && !this.bodyContainer && (this.container.style.position = "relative"), this.bind()
                    },
                    select: function(t, e, n) {
                        ...
                        return !!(t = this.get(t)) && (this.config.toggle && "drag" === this.config.toggle && !e && t.selected && !this.cmdDown ? this.deselect(t, !1) : (o = t.node, s = this.config.classes, c.remove(o, s.selecting), c.add(o, s.selected), t.selecting = !1, t.selected = !0, t.startselected = !0, n && this.config.saveState && this.state("save"), this.emit(15 > this.v[1] ? "selectable.select" : "selecteditem", t), t))
                    },
                    deselect: function(t, e) {
                        ...
                        if (t = this.get(t)) {
                            ...
                            return t.selecting = !1, t.selected = !1, t.deselecting = !1, t.startselected = !1, c.remove(n, o.deselecting), c.remove(n, o.selecting), c.remove(n, o.selected), e && this.config.saveState && this.state("save"), this.emit(15 > this.v[1] ? "selectable.deselect" : "deselecteditem", t), t
                        }
                        return !1
                    },
                    toggle: function(t) {
                    ...
                    remove: function(t, e) {
                        if (t = this.get(t)) {
                            if (i(t))
                                for (var n = t.length - 1; 0 <= n; n--) this.remove(t[n], 0 < n);
                            else {
                                n = t.node;
                                var o = this.config.classes,
                                    s = c.remove;
                    ...
                    state: function(t) {
                        ...
                        switch (t) {
                            case "save":
                                this.states = this.states || [], this.states.push(this.getSelectedNodes()), n = this.config.saveState, (n = "isInteger" in Number ? Number.isInteger(n) : !isNaN(n)) && this.states.length > this.config.saveState && this.states.shift(), this.currentState = this.states.length - 1, n = !0;
                                break;
                            case "undo":
                    ...
                    enable: function() {
                        if (!this.enabled) {
                            ...
                            this.enabled = !0, this.canShift = 0 <= t.indexOf("shiftKey"), this.canCtrl = 0 <= t.indexOf("ctrlKey"), this.canMeta = 0 <= t.indexOf("metaKey"), this.bind(), c.add(this.container, this.config.classes.container), this.emit(15 > this.v[1] ? "selectable.enable" : "enabled")
                        }
                        return this.enabled
                    },
                    disable: function() {
                    ...
                    emit: function(t) {
                        if (this.listeners = this.listeners || {}, 0 != t in this.listeners)
                            for (var e = 0; e < this.listeners[t].length; e++) this.listeners[t][e].apply(this, Array.prototype.slice.call(arguments, 1))
                    },
                    ...
                    _start: function(n) {
                        ...
                        if (!(!this.container.contains(n.target) || 3 === n.which || 0 < n.button || r.disabled)) {
                            ...
                            if (!(h = e(n.target, (function(t) {
                                    return t === o.container || c.contains(t, r.classes.selectable)
                                })))) return !1;
                            if (-1 === ["INPUT", "SELECT", "BUTTON", "TEXTAREA", "OPTION"].indexOf(n.target.tagName) && n.preventDefault(), this.dragging = !0, this.origin = {
                                ...
                                }, this.lasso && this.container.appendChild(this.lasso), h !== this.container ? ((s = this.get(h)).selecting = !0, c.add(h, r.classes.selecting)) : "sequential" == r.lassoSelect && (h = t(s, this.items)), r.autoRefresh && this.refresh(), l && this.startEl && h !== this.container) {
                                u = this.items;
                                for (var f = (s = this.getNodes().indexOf(h)) < (p = this.getNodes().indexOf(this.startEl)) ? 1 : -1;
                                    (s += f) && s !== p;) u[s].selecting = !0
                            }
                            for (u = 0; u < this.items.length; u++) f = (p = (s = this.items[u]).node) === h, s.selected && (s.startselected = !0, (r.toggle || a ? !f : f || l) || (c.remove(p, r.classes.selected), s.selected = !1, c.add(p, r.classes.deselecting), s.deselecting = !0)), f && (i = s);
                    ...
                    _drag: function(t) {
                        ...
                        if (!(e.disabled || !this.dragging || t.shiftKey && this.canShift)) {
                            ...
                            this.autoscroll && (this.bodyContainer || (this.coords.x1 -= this.boundingRect.x1, this.coords.y1 -= this.boundingRect.y1), this._autoScroll()), this.lasso && (this.bodyContainer || !this.autoscroll || this.config.autoScroll.lassoOverflow || this._limitLasso(), s(this.lasso, {
                                left: this.coords.x1,
                                top: this.coords.y1,
                    ...
                    _end: function(t) {
                        if (this.dragging) {
                            ...
                            var n = this.config,
                                ...
                                d = n.maxSelectable;
                            this.lasso && this.container.contains(this.lasso) && this.container.removeChild(this.lasso), this.lasso && (s(this.lasso, {
                                opacity: 0,
                                left: 0,
                                width: 0,
                                top: 0,
                                height: 0
                            }), (i = document.elementFromPoint(o.pageX, o.pageY)) || (i = this.container)), i = e(i, (function(t) {
                                return c.contains(t, n.classes.selectable)
                            })), o = !1;
                            for (var h = 0; h < this.items.length; h++) {
                                var u = this.items[h];
                                n.toggle && u.node === i && u.node === this.startEl && u.selecting && u.startselected && (u.deselecting = !0, u.selecting = !1), u.deselecting && (a.push(u), this.deselect(u, !1)), u.selecting && (d && l + r.length >= d ? (u.selecting = !1, c.remove(u.node, n.classes.selecting), o = !0) : (r.push(u), this.select(u, !1, !1)))
                            }
                    ...
                    _keydown: function(t) {
                        ...
                        if (void 0 !== t.key ? e = t.key : void 0 !== t.keyCode && (e = t.keyCode), e)
                            if (this.cmdDown && this.focused) switch (e) {
                                case 65:
                                case "a":
                                case "A":
                    ...
                    _onScroll: function(t) {
                        for (this.scroll.x = this.bodyContainer ? window.pageXOffset : this.container.scrollLeft, this.scroll.y = this.bodyContainer ? window.pageYOffset : this.container.scrollTop, t = 0; t < this.items.length; t++) this.items[t].rect = r(this.items[t].node)
                    },
                    _loadItems: function() {
                        var t, e = this.config;
                    ...
                    _sequentialSelect: function(t) {
                        ...
                        if (n && (n = n.closest("." + e.selectable))) {
                            if (this.mouse.y > this.origin.y) var i = this.nodes.indexOf(this.startEl),
                    ...
                    _get2DTransformation: function(t) {
                        var e = (t = window.getComputedStyle(t, null)).getPropertyValue("-webkit-transform") || t.getPropertyValue("-moz-transform") || t.getPropertyValue("-ms-transform") || t.getPropertyValue("-o-transform") || t.getPropertyValue("transform") || !1;
                        if (e && "none" !== e) {
                            e = e.split("(")[1].split(")")[0].split(", ");
                            var n = parseFloat(e[0]),
                                i = parseFloat(e[1]),
                                o = Math.sqrt(n * n + i * i);
                            return t = t.transformOrigin.split(" ").map((function(t) {
                                return parseFloat(t)
                            })), {
        ...
        Xt = function() {
            function t() {
                this.isActivated = !1, this.links = document.querySelectorAll("a"), this.linksMap = [], this.selected = [], this.nodes = j(document.querySelectorAll("[data-id]")).filter((function(t) {
            ...
            return t.prototype.activate = function() {
                var t = this;
                this.isActivated || (console.log("multi-select-activate"), this.disableLinks(), this.selectableInstance = new Gt({
                    filter: j(this.nodes),
                    tolerance: "fit",
                    autoScroll: {
                        threshold: 40,
                    ...
                    var e, n = t.selectableInstance.items.reduce((function(e, n) {
                            if (n.selected) {
                                var i = E(E({}, n), {
                    ...
                    e = 1 == i.length ? i[0] : t.getLowestCommonParent.apply(t, j([i[0]], i.slice(1))), parent.postMessage({
                ...
                var i, o = "contains" in t ? "contains" : "compareDocumentPosition",
                    s = "contains" === o ? 1 : 16,
                    r = [].slice.call(arguments, 1);
                t: for (; t = t.parentNode;) {
                    for (i = r.length; i--;)
                        if ((t[o](r[i]) & s) !== s) continue t;
                    return t
                }
                return null
            }, t = O([G.Service(), I("design:paramtypes", [])], t)
        ...
        Qt = "open-compare",
        Zt = G.Container.get(Wt),
        Kt = G.Container.get(K);
    window.commonService = Zt, Zt.injectGlobalStyles(), Zt.injectTurbo(), Zt.loadQueryParams(), document.addEventListener("DOMContentLoaded", (function() {
        window.hotspotsService = Kt, requestAnimationFrame((function() {
            Zt.saveQueryParams(window.location.href), Zt.showActionLinks()
                    ...
                    case "v2":
                        ! function(t, e) {
                            var n = (void 0 === e ? {} : e).codeModeV2,
                                i = void 0 !== n && n,
                                o = G.Container.get(K),
                                s = G.Container.get(Ut),
                                r = G.Container.get(Xt),
                                a = G.Container.get(Wt),
                                l = i ? G.Container.get(Yt) : G.Container.get(Z);
                            switch (t.data.action) {
                                case "dom-load":
                                    a.styleScrollbar();
                                    break;
                                case "change-screen":
                                    window.Turbo.visit(t.data.slug + "?handoff=1"), t.data.slugs && (a.setPageSlugs(t.data.slugs), a.injectPreloadLinks());
                                    break;
                                case "update-slugs":
                                ...
                                case "scroll":
                                    ...
                                    switch (d.deltaMode) {
                                        ...
                                        case 1:
                                            ...
                                            break;
                                        case 2:
                                            window.scrollTo(window.scrollX + .03 * d.deltaX, window.scrollY + .03 * d.deltaY)
                                    }
                                    break;
                                case Qt:
                                    parent.postMessage({
            ...
            "Escape" === t.key && parent.postMessage({
        ...
        Zt.saveQueryParams(t.detail.url), Zt.updatePageNum()
    })), document.addEventListener("turbo:load", (function() {
        Zt.injectPreloadLinks(), setTimeout((function() {
        ...
        Zt.patchAsyncSrc(t.detail.newBody), Zt.loadQueryParams()
    })), document.addEventListener("turbo:render", (function() {
        Zt.styleScrollbar(), Zt.showActionLinks(), Kt.updateHostposts(), parent.postMessage({
            action: "turbo-render"
        }, "*")
    }))
}();